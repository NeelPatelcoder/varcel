  ...
  const OrderHistory = ()=>{
    ...
    return(
        <div className="container">
            <div className="center-align white-text" style={{marginTop:"10px",borderRadius:'2rem',backgroundColor:"#1565c0",padding:"3px"}} >
                <h4>{user.name}</h4>
                <h4>{user.email}</h4>
            </div>
            <h3>Order History</h3>
            ...
            {/* {"name":"Neel","role":"root","email":"neel@gmail.com"} */}
            {user.role == "root"
            &&<UserRoles />
            } 
        </div>
